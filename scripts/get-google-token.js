 ...
 *
 * Run this to get a refresh token for Gmail + Sheets API access.
...
const REDIRECT_URI = 'http://localhost:3848/callback';
const SCOPES = [
...
console.log('\n=== Google OAuth Token Generator (Gmail + Sheets) ===\n');
...
console.log('\nWaiting for callback on http://localhost:3848 ...\n');
  ...
  if (url.pathname === '/callback') {
    ...
    if (code) {
      ...
      try {
        ...
        console.log('Gmail + Sheets integration is now configured!\n');
        console.log('Test with: npm run test:sheets\n');
        ...
        res.end(`
          <html>
            <body style="font-family: system-ui; padding: 40px; text-align: center;">
              <h1>✓ Success!</h1>
              <p>Gmail + Sheets OAuth configured. You can close this window.</p>
...
server.listen(3848, () => {
  console.log('Server listening on port 3848...');
});
